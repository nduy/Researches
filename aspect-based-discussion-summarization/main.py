...
def add_args(parser):
    ...
    parser.add_argument('--node_freq_min', action='store', type=int,
                        ...
                        default=1)
    parser.add_argument('--load_2000_only', action='store_true',
                        help='Only load first 2000 records from dataset',
                        default=False)
...
if __name__ == "__main__":
    ...
    if args.art_path and args.com_path is None:  # Article only mode
        ...
        comments, comment_js, comment_des = read_comment_file(args.com_path,
                                                              read_as_threads=False, load_2k = args.load_2000_only)
        title = ""
        article = ""
    ...
    if args.evaluate_conversation and args.truth_conversation_path:
        ...
        if args.load_2000_only:
            all_ground_truth = all_ground_truth[:2000]
