...
if __name__ == '__main__':
    ...
    doc_ids = [line.rstrip() for line in open('./data/nyt.online_lead_top10.shelf_2001_test.ids')]
    multi_docs = [line.rstrip() for line in open('./data/nyt.online_lead_top10.shelf_2001_test.text')]
    ground_truth = [line.rstrip() for line in open('./data/nyt.online_lead_top10.shelf_2001_test.truth')]
    train_multi_docs = [line.rstrip() for line in open('./data/nyt.online_lead_top10.shelf_2001_train.text')]
    train_ground_truth = [line.rstrip() for line in open('./data/nyt.online_lead_top10.shelf_2001_train.truth')]
